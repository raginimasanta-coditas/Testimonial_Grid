...
import image from "../assets/image-daniel.jpg";
      ...
      <div style={{ width: "800px", height: "400px", margin: "auto auto" }}>
        <div class="grid-container">
          ...
          >
            ...
            <div style={{ boxSizing: "content-box" }} className="first-para">
              I received a job offer mid-course, and the subjects I learned were
              current, if not more so, in the company I joined. I honestly feel
              I got every penny’s worth.
            </div>
            <div style={{ boxSizing: "content-box" }} className="second-para">
          ...
          >
            ...
            <div
              style={{ boxSizing: "content-box", color: "hsl(219, 29%, 14%)" }}
